<template>
    <div id="home">
        ...
        <router-link 
         ...
         tag="div"
         to="/admin/addProduct">
            <img src="../../assets/addproduct.png">
            <p>Ürünleri Düzenle</p>
        </router-link>
        ...
        <router-link
         ...
         tag="div"
         to="/admin/addImage">
            <img src="../../assets/addimage1.png">
            <p>Resimleri Düzenle</p>
        </router-link>
