<template>
    <div id="addAnnouncemenet">
        ...
        <div id="list">
            <div class="listdiv" v-for="(item,index) in getAnnouncements" :key="index">
                <div class="listitem">
                ...
                <div class="action">
                    <div class="edit">
                        <img src="../../assets/edit.png" @click="setItem(item.id)" title="Düzenle">
                    </div>
                    <div class="delete">
                        <img src="../../assets/delete.png" @click="deleteItem(item.id)" title="Sil">
                    </div>
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    input[type="date"]{
        ...
        outline: none;
        cursor: pointer;
        box-shadow: inset 0 0 .5vmax grey;
        border-radius: .5vmax;
        padding: .2vmax 1vmax;
        display: flex;
        justify-content: flex-start;
